...
void LbpBase::SetPastaCaracateristica(string pastaCaracateristica)
{
	this->pastaCaracateristica = pastaCaracateristica;
}

string LbpBase::GetPastaCaracateristica()
{
	return this->pastaCaracateristica;
}

void LbpBase::SetNaoPastaCaracateristica(string pastaNaoCaracateristica)
{
	this->pastaNaoCaracateristica = pastaNaoCaracateristica;
}

string LbpBase::GetNaoPastaCaracateristica()
{
